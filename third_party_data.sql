...
-- -----------------------------------------------------
-- Table `third_party_data`.`other_data`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `third_party_data`.`other_data` (
...
ALTER TABLE `other_data`
    ADD CONSTRAINT `chk_avgBusinessAcademyDropoutPct_range` CHECK (`avgBusinessAcademyDropoutPct` BETWEEN 0 AND 100);
    ADD CONSTRAINT `chk_avgBusinessAcademyUnemploymentNewGradPct_range` CHECK (`avgBusinessAcademyUnemploymentNewGradPct` BETWEEN 0 AND 100);
...
INSERT INTO other_data (avgBusinessAcademyDropoutPct, avgBusinessAcademyUnemploymentNewGradPct) VALUES
  ('20.6', '6.7')